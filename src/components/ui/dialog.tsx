    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close asChild>
          <button className="absolute right-4 top-4 rounded-base border-2 border-border bg-secondary-background p-2 cursor-pointer hover:bg-main transition-colors focus:outline-hidden focus:ring-2 focus:ring-black focus:ring-offset-2">
            <X className="size-4" />
